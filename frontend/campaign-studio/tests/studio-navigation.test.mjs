...
test("UX V2 mantiene cinco espacios y un registro central de acciones", async () => {
  const source = await readFile(new URL("../lib/studio-navigation.ts", import.meta.url), "utf8");
...
test("la matriz protege las capacidades críticas de v44", async () => {
  const matrix = await readFile(new URL("../docs/UX_V2_REGRESSION_MATRIX.md", import.meta.url), "utf8");
