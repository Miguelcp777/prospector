...
import { Dialog, DialogContent, DialogDescription, DialogHeader, DialogTitle } from "@studio/ui/dialog";
...
import { buildEml, documentForLead, extractTemplateLinks, imageCostEstimate, mergeDataForLead, reimagineDocument, reviewCampaign, SECTION_LIBRARY_200, type LeadProfile, type ReviewIssue, type SectionCategory } from "@studio/lib/campaign-enhancements";
import { renderEmailHtml } from "@studio/lib/email-renderer";
import { combineVariantDocuments, createExperimentPlan, estimateAttention, rankMediaAssets, simulateEmailClient, type CampaignSegment, type EmailClientProfile } from "@studio/lib/studio-finalization";
import type { EmailBlock, TemplateDocument } from "@studio/lib/template-types";
